...
from tkt.Utils import weather,sendmail,texttospeech,Youtube,Crypto,tktUtil
from tkt.Utils.errors import InternalError,OutOfService
from tkt.Translation import translator
from tkt.Voice.SpeechRecongition import recon
from tkt.Tiktok import Script_2,Script_1,Base
...
class Toolkit:
    ...
    def mail(From:str, To:str, Subject:str, Content:str, Login_Email:str, Login_PW:str, Port:int, Server:str):
        """
        We recommend to NOT use this function as it
        has various flaws, that will be fixed soon.
        """
        print(colored('We recommend to NOT use this function as it has various flaws, that will be fixed soon.','red'))
        sendmail.sendmail(From,To,Subject,Content,Login_Email,Login_PW,Port,Subject)
